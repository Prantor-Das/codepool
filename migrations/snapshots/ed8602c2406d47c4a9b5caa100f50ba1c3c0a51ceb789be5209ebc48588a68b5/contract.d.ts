...
export type StorageHash =
  StorageHashBase<'ed8602c2406d47c4a9b5caa100f50ba1c3c0a51ceb789be5209ebc48588a68b5'>;
export type ExecutionHash =
  ExecutionHashBase<'86dc5cb36fde1e4f92e4592fb5af3830721f6515da6cce99a3d46b35c0c1abfc'>;
...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly Repository: {
      readonly id: CodecTypes['pg/text@1']['output'];
      readonly githubId: CodecTypes['pg/int8@1']['output'];
    ...
    readonly Review: {
      readonly id: CodecTypes['pg/text@1']['output'];
      readonly repositoryId: CodecTypes['pg/text@1']['output'];
      readonly prNumber: CodecTypes['pg/int4@1']['output'];
      readonly prTitle: CodecTypes['pg/text@1']['output'];
      readonly prUrl: CodecTypes['pg/text@1']['output'];
...
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly Repository: {
      readonly id: CodecTypes['pg/text@1']['input'];
      readonly githubId: CodecTypes['pg/int8@1']['input'];
    ...
    readonly Review: {
      readonly id: CodecTypes['pg/text@1']['input'];
      readonly repositoryId: CodecTypes['pg/text@1']['input'];
      readonly prNumber: CodecTypes['pg/int4@1']['input'];
      readonly prTitle: CodecTypes['pg/text@1']['input'];
      readonly prUrl: CodecTypes['pg/text@1']['input'];
        ...
        readonly entries: {
          readonly table: {
            ...
            readonly repository: {
              ...
              indexes: readonly [
                {
                  readonly name: 'repository_userId_idx_a489d58a';
                  readonly prefix: 'repository_userId_idx';
                  readonly columns: readonly ['userId'];
                  readonly unique: false;
                },
              ];
            ...
            readonly review: {
              ...
              indexes: readonly [
                {
                  readonly name: 'review_repositoryId_idx_dce7a8ba';
                  readonly prefix: 'review_repositoryId_idx';
...
> & {
  ...
  readonly roots: {
    ...
    readonly webhook_delivery: {
      readonly namespace: 'public' & NamespaceId;
      readonly model: 'WebhookDelivery';
    };
  };
  readonly domain: {
    readonly namespaces: {
      readonly public: {
        readonly models: {
          ...
          readonly Review: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly prTitle: { readonly column: 'prTitle' };
                readonly prUrl: { readonly column: 'prUrl' };
          ...
          readonly WebhookDelivery: {
            ...
            readonly relations: Record<string, never>;
            readonly storage: {
              readonly table: 'webhook_delivery';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly id: { readonly column: 'id' };
